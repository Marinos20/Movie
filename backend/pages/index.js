     ...
     {loading ? <Loading /> : <div className="container">
      <div className="topheadertitle flex flex-sb">
        <div>
          ...
          <p className="mb-2 w-66 ">It’s time for another 
Authenticatweist gets updated in real-time on the backend. Subscribed clients will instantly see these changes.</p>
      <Link href="/"><button> Exclusive on <span>Makemovie</span></button> </Link>
        </div>
      ...
      <div className="moviecards flex flex-col flrx-left gap-2 w-100">


        <div className="flex flex-sb w-100 movietitle">

          <h2> List of Last Movie</h2>
        ...
        {publishedMovies.slice(0.3).map((movie) => {
          ...
          <div className="moviecardinfo">
            ...
            <div className="flex gap-2 mt-2">
              ...
              <Link href={`/movies/delete/${movie._id}`}> <button>Delect movie</button> </Link>
